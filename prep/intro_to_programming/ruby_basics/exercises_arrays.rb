...
# Select 'fish' and 'lizard' from pets at the same time, assign the return value to a
#  variable named my_pets, then print the value of my_pets.
...
=begin
Iteration is a key task when it comes to Arrays. When using #each, it's important
to note the block parameter: here we use color. This represents the element in the
current iteration and can be named whatever you want. Knowing this, it is easy to
print each element simply by using #puts.
...
doubled_numbers = numbers.map { |n| n * n }
p doubled_numbers
...
# numbers divisible by three. Assign the returned array to a variable named
...
puts array1 & array2 == array2 # OR puts array1 == array2
